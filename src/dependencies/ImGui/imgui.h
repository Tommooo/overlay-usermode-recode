...
struct ImDrawList
{
    ...
    IMGUI_API void  AddCornerBox( float x, float y, float w, float h, ImColor color );
    ...
    IMGUI_API void  AddTextOutline(const ImVec2& pos, ImU32 col, const char* text_begin, int alpha = 255, const char* text_end = NULL);
